...
After implementing Redis/Valkey caching and tuning PostgreSQL, the quiz app now sustains **5000 concurrent users with 0% error rate**. This represents a **3x improvement** from the previous ceiling of ~1600 VUs.
