...
<Callout type="info">
  If you create a **GitHub App** instead of an OAuth App, go to _Permissions and Events_ → _Account
  Permissions_ → _Email Addresses_ and set it to "Read-Only". This is required to read the user's
  email address.
</Callout>
